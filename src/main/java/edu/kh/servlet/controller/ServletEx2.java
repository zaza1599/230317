...
// Servlet 코드를 작성하기 위해서는 HttpServlet 상속 받아야 한다!
...
protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	...
	String orderer = req.getParameter("order");
	// radio 버튼은 1개만 선택 가능 = =값 1개만 서버로 제출 됨
	String type = req.getParameter("type");
	
	// select 박스는 1개의 option만 선택 가능 == 값 1개만 서버로 제출 됨
